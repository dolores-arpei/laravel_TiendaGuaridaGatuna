                            ...
                            @forelse($products as $product)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        @else
                                            <div
                                                class="h-16 w-16 bg-gray-100 flex items-center justify-center rounded-md text-4xl">
                                                📦
                                            </div>
                                        @endif
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center">
                                        ...
                                        <p class="text-gray-400 text-sm mt-2">Crea tu primer producto usando el botón de
                                            arriba</p>
                                    </td>
                                </tr>
                            @endforelse
